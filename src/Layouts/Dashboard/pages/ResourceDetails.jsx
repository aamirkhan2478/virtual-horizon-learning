                  ...
                  {user?.userType === "Teacher" && data.isAssigned && (
                    <>
                      <Button
                        ...
                        onClick={() =>
                          navigate(`/dashboard/${id}/generate-quiz`)
                        }
                      >
                        Generate Quiz
                      </Button>
                      <Button
                        ...
                        onClick={() =>
                          navigate(`/dashboard/${id}/add-assignment`)
                        }
                      >
                        Add Assignment
                      </Button>
                      <Button
                        className="mt-4 bg-orange-600 hover:bg-orange-500 focus:bg-orange-500"
                        onClick={() =>
                          navigate(`/dashboard/${id}/submitted-assignments`)
                        }
                      >
                        Submitted Assignments
                      </Button>
                      <Button
                        className="mt-4 ml-3 bg-slate-600 hover:bg-slate-500 focus:bg-slate-500"
                        onClick={() => navigate(`/dashboard/${id}/view-scores`)}
                      >
                        View Scores
                      </Button>
                    </>
